...
const AboutLeftSection = () => {
  return (
    <Reveal animation="fade-right" className="about-left-container">
      <LazyImage src="/gif/PhoneGIF.gif" className="about-iphone" alt="Phone animation" />
    </Reveal>
  );
};
...
const AboutRightSection = ({ jp }: { jp: boolean }) => {
  return (
    <Reveal className="about-right-container">
      <h2 className="about-header">{jp ? 'Hey There!' : 'Hey There!'}</h2>
      <p className="about-right-content">
        {jp
