        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <XAxis dataKey="label" style={{ fill: 'white' }}>
              <Label value="Years" offset={-5} position="insideBottom"  style={{ fill: 'white' }}/>
            </XAxis>
            <YAxis
             style={{ fill: 'white' }}
            />
            <Tooltip content={renderTooltip} wrapperStyle={{ color: 'white', backgroundColor: 'black', padding: '.5rem 1rem', borderRadius: '15px' }}/>
